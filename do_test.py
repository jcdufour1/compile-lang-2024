...
EXPECT_FAIL_FILE_PATH_TO_TYPE: dict[str, list[str]] = {
    ...
    EXPECTED_FAIL_EXAMPLES_DIR + "missing_close_par_2.own": ["expected-expression"], # TODO: uncomment this missing-close-par?:, "missing-close-par",
    ...
    EXPECTED_FAIL_EXAMPLES_DIR + "def_invalid_syntax.own": ["parser-expected"] + ["parser-expected"],
