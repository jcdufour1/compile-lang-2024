...
static_assert(DIAG_COUNT == 103, "exhaustive handling of expected fail types");
static const Expect_fail_pair expect_fail_pair[] = {
    ...
    {"expected-type-but-got-expr", DIAG_EXPECTED_TYPE_BUT_GOT_EXPR, LOG_ERROR, true, false},
    {"expected-expr-but-got-type", DIAG_EXPECTED_EXPR_BUT_GOT_TYPE, LOG_ERROR, true, false},
