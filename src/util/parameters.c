...
static const Expect_fail_pair expect_fail_pair[] = {
    ...
    {"directory-could-not-be-made", DIAG_DIR_COULD_NOT_BE_MADE, LOG_ERROR, true},
    ...
    {"invalid-member-access-callee", DIAG_INVALID_MEMBER_ACCESS_CALLEE, LOG_ERROR, true},
    {"invalid-member-access", DIAG_INVALID_MEMBER_ACCESS, LOG_ERROR, true},
    {"missing-return-in-fun", DIAG_MISSING_RETURN_IN_FUN, LOG_ERROR, true},
    {"missing-return-in-defer", DIAG_MISSING_RETURN_IN_DEFER, LOG_ERROR, true},
    ...
    {"soft-not-yet-implemented", DIAG_SOFT_NOT_YET_IMPLEMENTED, LOG_WARNING, true},
    ...
    {"lang-def-in-runtime", DIAG_LANG_DEF_IN_RUNTIME, LOG_ERROR, true},
    {"type-could-not-be-infered", DIAG_TYPE_COULD_NOT_BE_INFERED, LOG_ERROR, true},
    {"expected-type-but-got-expr", DIAG_EXPECTED_TYPE_BUT_GOT_EXPR, LOG_ERROR, true},
    {"expected-expr-but-got-type", DIAG_EXPECTED_EXPR_BUT_GOT_TYPE, LOG_ERROR, true},
    {"invalid-type", DIAG_INVALID_TYPE, LOG_ERROR, true},
    {"non-int-literal-in-static-array", DIAG_NON_INT_LITERAL_IN_STATIC_ARRAY, LOG_ERROR, true},
    {"expected-variable-def", DIAG_EXPECTED_VARIABLE_DEF, LOG_ERROR, true},
    {"using-on-non-struct-variable", DIAG_USING_ON_NON_STRUCT_VARIABLE, LOG_ERROR, true},
    {"def-dest-and-src-both-have-gen-args", DIAG_DEF_DEST_AND_SRC_BOTH_HAVE_GEN_ARGS, LOG_ERROR, true},
    {"yield-out-of-error-handling-block", DIAG_YIELD_OUT_OF_ERROR_HANDLING_BLOCK, LOG_ERROR, true},
    {"orelse-err-symbol-on-optional", DIAG_ORELSE_ERR_SYMBOL_ON_OPTIONAL, LOG_ERROR, true},
    {"mismatched-error-t", DIAG_MISMATCHED_ERROR_T, LOG_ERROR, true},
    {"result-expected-on-question-mark-lhs", DIAG_RESULT_EXPECTED_ON_QUESTION_MARK_LHS, LOG_ERROR, true},
    {"assignment-used-as-expression", DIAG_ASSIGNMENT_USED_AS_EXPRESSION, LOG_ERROR, true},
    {"if-let-invalid_syntax", DIAG_IF_LET_INVALID_SYNTAX, LOG_ERROR, true},
    {"static-array-count-not-infered", DIAG_STATIC_ARRAY_COUNT_NOT_INFERED, LOG_ERROR, true},
    {"invalid-index-callee", DIAG_INVALID_INDEX_CALLEE, LOG_ERROR, true},
};
