...
typedef enum {
    ...
    DIAG_FUNCTION_PARAM_NOT_SPECIFIED,
    ...
    DIAG_EXPECTED_TYPE_BUT_GOT_EXPR,
    ...
    DIAG_GOT_TYPE_BUT_EXPECTED_EXPR,
    DIAG_GOT_EXPR_BUT_EXPECTED_TYPE,
    DIAG_INVALID_ATTR,
    DIAG_INVALID_STRING_LITERAL,
