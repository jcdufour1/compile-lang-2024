...
static Uast_type lang_type_gen_primitive(const char* prefix) {
    ...
    darr_append(&a_gen, &lang_type.sub_types, lang_type_gen_signed_int(base_name));
    darr_append(&a_gen, &lang_type.sub_types, lang_type_gen_unsigned_int(base_name));
    darr_append(&a_gen, &lang_type.sub_types, lang_type_gen_float(base_name));
    darr_append(&a_gen, &lang_type.sub_types, lang_type_gen_opaque(base_name));
...
static Uast_type lang_type_gen_lit(const char* prefix) {
    ...
    darr_append(&a_gen, &lang_type.sub_types, lang_type_gen_int_lit(base_name));
    darr_append(&a_gen, &lang_type.sub_types, lang_type_gen_float_lit(base_name));
    darr_append(&a_gen, &lang_type.sub_types, lang_type_gen_string_lit(base_name));
    darr_append(&a_gen, &lang_type.sub_types, lang_type_gen_struct_lit(base_name));
    darr_append(&a_gen, &lang_type.sub_types, lang_type_gen_fn_lit(base_name));
...
static Uast_type lang_type_gen_tuple(const char* prefix) {
    ...
    append_member(&sym.members, "Lang_type_darr", "lang_types");
    append_member(&sym.members, "int16_t", "pointer_depth");
...
static Uast_type lang_type_gen_lang_type(void) {
    ...
    darr_append(&a_gen, &lang_type.sub_types, lang_type_gen_primitive(base_name));
    darr_append(&a_gen, &lang_type.sub_types, lang_type_gen_struct(base_name));
    darr_append(&a_gen, &lang_type.sub_types, lang_type_gen_raw_union(base_name));
    darr_append(&a_gen, &lang_type.sub_types, lang_type_gen_enum(base_name));
    darr_append(&a_gen, &lang_type.sub_types, lang_type_gen_tuple(base_name));
    darr_append(&a_gen, &lang_type.sub_types, lang_type_gen_void(base_name));
    darr_append(&a_gen, &lang_type.sub_types, lang_type_gen_fn(base_name));
    darr_append(&a_gen, &lang_type.sub_types, lang_type_a_genrray(base_name));
    darr_append(&a_gen, &lang_type.sub_types, lang_type_gen_lit(base_name));
    darr_append(&a_gen, &lang_type.sub_types, lang_type_gen_removed(base_name));
