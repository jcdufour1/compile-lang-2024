...
static inline Str_view serialize_tast_struct_def(Env* env, const Tast_struct_def* def) {
    Tast_def* dummy = NULL;
...
static inline Str_view serialize_tast_raw_union_def(Env* env, const Tast_raw_union_def* def) {
    Tast_def* dummy = NULL;
...
static inline Str_view serialize_tast_sum_def(Env* env, const Tast_sum_def* def) {
    Tast_def* dummy = NULL;
