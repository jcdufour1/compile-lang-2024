...
Str_view node_binary_print_internal(const Node_binary* binary) {
    ...
    recursion_depth++;
    string_extend_strv_indent(&print_arena, &buf, node_expr_print_internal(binary->lhs), recursion_depth);
    string_extend_strv_indent(&print_arena, &buf, node_expr_print_internal(binary->rhs), recursion_depth);
    recursion_depth--;
...
void extend_sym_typed_base(String* string, Sym_typed_base base) {
    ...
    string_extend_strv_indent(&print_arena, string, base.name, recursion_depth);
...
Str_view node_symbol_untyped_print_internal(const Node_symbol_untyped* sym) {
    ...
    string_extend_strv_indent(&print_arena, &buf, sym->name, recursion_depth);
    string_extend_cstr(&print_arena, &buf, "\n");
...
Str_view node_member_access_untyped_print_internal(const Node_member_access_untyped* access) {
    ...
    string_extend_strv_indent(&print_arena, &buf, access->member_name, recursion_depth);
...
Str_view node_function_call_print_internal(const Node_function_call* fun_call) {
    ...
    string_extend_strv_indent(&print_arena, &buf, fun_call->name, recursion_depth);
...
Str_view node_string_print_internal(const Node_string* num) {
    String buf = {0};
...
Str_view node_alloca_print_internal(const Node_alloca* alloca) {
    ...
    string_extend_strv_indent(&print_arena, &buf, alloca->name, recursion_depth);
    string_extend_cstr(&print_arena, &buf, "\n");
    recursion_depth--;
...
Str_view node_label_print_internal(const Node_label* label) {
    ...
    recursion_depth++;
    string_extend_strv(&print_arena, &buf, label->name);
    string_extend_cstr(&print_arena, &buf, "\n");
    recursion_depth--;
