...
static inline Ir_lang_type_atom ir_lang_type_primitive_get_atom_normal(Ir_lang_type_primitive ir_lang_type) {
...
static inline Ir_lang_type_atom ir_lang_type_primitive_get_atom_c(Ir_lang_type_primitive ir_lang_type) {
    switch (ir_lang_type.type) {
        case IR_LANG_TYPE_FLOAT: {
            String string = {0};
...
static inline Ir_lang_type_atom ir_lang_type_primitive_get_atom(LANG_TYPE_MODE mode, Ir_lang_type_primitive ir_lang_type) {
    switch (mode) {
...
static inline Ir_lang_type_atom ir_lang_type_get_atom(LANG_TYPE_MODE mode, Ir_lang_type ir_lang_type) {
    switch (ir_lang_type.type) {
...
static inline void ir_lang_type_primitive_set_atom(Ir_lang_type_primitive* ir_lang_type, Ir_lang_type_atom atom) {
    switch (ir_lang_type->type) {
        case IR_LANG_TYPE_SIGNED_INT:
...
static inline void ir_lang_type_set_atom(Ir_lang_type* ir_lang_type, Ir_lang_type_atom atom) {
    switch (ir_lang_type->type) {
        case IR_LANG_TYPE_PRIMITIVE:
