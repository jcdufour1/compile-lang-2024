...
bool try_set_block_types(Tast_block** new_tast, Uast_block* tast, bool is_directly_in_fun_def, bool new_sym_tbl);

STMT_STATUS try_set_stmt_types(Tast_stmt** new_stmt, Uast_stmt* stmt);
