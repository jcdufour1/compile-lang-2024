...
Llvm_block* add_load_and_store(Tast_block* old_root) {
    ...
    Llvm_block* block = load_block(old_root, DEFER_PARENT_OF_TOP_LEVEL, (Lang_type) {0});
    return block;
}
