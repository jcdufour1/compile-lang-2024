...
static inline void vector_reserve(Arena* arena, void* typed_vector, size_t size_each_item, size_t minimum_count_empty_slots, size_t init_capacity) {
...
static inline void vector_append(Arena* arena, void* typed_vector, size_t size_each_item, const void* item_to_append, size_t init_capacity) {
    Vector* vector = (Vector*)typed_vector;
