...
static inline Ulang_type_reg_generic ulang_type_reg_generic_clone(Ulang_type_reg_generic lang_type) {
...
static inline Ulang_type ulang_type_clone(Ulang_type lang_type) {
    switch (lang_type.type) {
        case ULANG_TYPE_REG_GENERIC:
            return ulang_type_reg_generic_const_wrap(ulang_type_reg_generic_clone(
