...
OBJS=\
	 ...
	 ${BUILD_DIR}/ast_utils/uast_expr_to_ulang_type.o \
...
${BUILD_DIR}/ast_utils/uast_expr_to_ulang_type.o: ${DEP_COMMON} src/ast_utils/uast_expr_to_ulang_type.c 
	${CC_COMPILER} ${C_FLAGS} -c -o ${BUILD_DIR}/ast_utils/uast_expr_to_ulang_type.o src/ast_utils/uast_expr_to_ulang_type.c
